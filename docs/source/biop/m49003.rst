...
.. hint::  psychology link-to-learning

    Click through this `interactive simulation <http://openstax.org/l/chospital>`__ for a closer look at
    neuronal communication.
...
.. table:: Major Neurotransmitters and How They Affect Behaviour
   
    +----------------------+----------------------+----------------------+
    | Neurotransmitter     | Involved in          | Potential Effect on  |
    |                      |                      | Behavior             |
    +======================+======================+======================+
    | Acetylcholine        | Muscle action,       | Increased arousal,   |
    |                      | memory               | enhanced cognition   |
    +----------------------+----------------------+----------------------+
    | Beta-endorphin       | Pain, pleasure       | Decreased anxiety,   |
    |                      |                      | decreased tension    |
    +----------------------+----------------------+----------------------+
    | Dopamine             | Mood, sleep,         | Increased pleasure,  |
    |                      | learning             | suppressed appetite  |
    +----------------------+----------------------+----------------------+
    | Gamma-aminobutyric   | Brain function,      | Decreased anxiety,   |
    | acid (GABA)          | sleep                | decreased tension    |
    +----------------------+----------------------+----------------------+
    | Glutamate            | Memory, learning     | Increased learning,  |
    |                      |                      | enhanced memory      |
    +----------------------+----------------------+----------------------+
    | Norepinephrine       | Heart, intestines,   | Increased arousal,   |
    |                      | alertness            | suppressed appetite  |
    +----------------------+----------------------+----------------------+
    | Serotonin            | Mood, sleep          | Modulated mood,      |
    |                      |                      | suppressed appetite  |
    +----------------------+----------------------+----------------------+
