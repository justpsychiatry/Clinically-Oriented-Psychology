...
Humans engage in :term:`aggression` when they seek to
cause harm or pain to another person. Aggression takes two forms
depending on one’s motives: hostile or instrumental. :term:`Hostile aggression` is motivated by feelings of anger
with intent to cause pain; a fight in a bar with a stranger is an
example of hostile aggression. In contrast, :term:`instrumental aggression` is motivated by achieving a goal and
...
:term:`frustration aggression theory`
...
bullying. :term:`Bullying` is repeated negative
...
diffusion of responsibility is the likely explanation. :term:`Diffusion of responsibility` is the tendency for no one in a
