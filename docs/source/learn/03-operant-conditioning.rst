...
goal, you would be using a :term:`primary reinforcer`.
...
rats explored the maze, they developed a :term:`cognitive map` a mental picture of the layout of the maze
