...
:term:`Consciousness` describes our awareness of
...
:term:`Sleep` is a state marked by relatively low levels of physical
activity and reduced sensory awareness that is distinct from periods of
rest that occur during wakefulness. :term:`Wakefulness` is characterized by 
...
.. admonition:: Coma, Stupor, and Clouding of Consciousness 
   :class: tip
...
:term:`Biological rhythms` are internal rhythms of
...
.. figure:: ../resources/CNX_Psych_04_01_Rhythmsn.jpg
   :scale: 100 %
   :alt: A photograph shows a line graph titled “Circadian Change in Body Temperature
   :align: center
...
example of a circadian rhythm. A :term:`circadian rhythm` 
...
If we have biological rhythms, then is there some sort of :term:`biological clock`? 
In the brain, the hypothalamus, which lies superior to the pituitary gland, 
is a main center of homeostasis. :term:`Homeostasis` is the tendency to
...
known as the :term:`suprachiasmatic nucleus (SCN)`.
...
.. figure:: ../resources/CNX_Psych_04_01_SCN.jpg
   :scale: 100 %
   :alt: An illustration showing the location of the suprachiasmatic nucleus in the brain.
...
is the hormone :term:`melatonin`. The :term:`pineal gland`, 
...
.. admonition::
   ...
   Use of electronic devices such as smartphones, tablets, and computers at night
...
differ in sleep regulation. :footcite:p:`taillardCircadianHomeostaticModulation2003`  
:term:`Sleep regulation` refers to the brain’s control of switching between sleep 
...
:term:`Jet lag` is a collection of symptoms that results
...
and :term:`insomnia` (i.e., a consistent difficulty in
...
disruptions in circadian cycles. :term:`Rotating shift work` refers
...
sleep less. In fact, a :term:`meta-analysis`, which is
...
day :footcite:p:`ohayonMetaAnalysisQuantitativeSleep2004`. 
