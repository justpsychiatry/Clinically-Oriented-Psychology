...
9.  Discussing or thinking about distressing or exciting issues can cause sympathetic
   responses and impair sleep. If issues must be discussed, they should 
   be discussed in the daytime, long before the time for sleep. 
   To avoid preoccupation with intrusive thoughts, the patient is advised to **count backward from 500**. 
...
.. admonition:: Insomnia in Depression
   :class: hint
...
This relationship is so robust
that some view the presence of RBD as a potential aid in the diagnosis
and treatment of several neurodegenerative 
...
One of the most common sleep apnea treatments involves using a
special device during sleep. 
A :term:`continuous positive airway pressure (CPAP)` device includes 
