...
Sleep-hygeine
=============
People who experience insomnia are often prescribed with hypnotics. 
In addition to their adverse effects, the therapeutic effects
of these is often temporary as tolerance develops quickly. 
The following are some of the principles of sleep-hygeine, measures
which can help people improve their sleep without the need for medications: 

1. Using rigid sleep-wake schedule even on weekends or other holidays is important for 
   the circadian rythms to work well. Disturbing the schedule affects this rythm and may lead to 
...
2. Exposure to sunlight in the day, and keeping dark at night also help regulate circadian rythms.
   ...
   avoided at night. If their use is unavoidable, brightness must be lowered to minimum 
   and a blue-light blocking filter shoudl be turned on.
...
4. Avoding day time nap should be the goal, if unavoidable, it should occur before 3 PM and last less than
   30 minutes. 
5. Ideally, one specific room and bed must be used for sleep and it must only be used for sleep. 
   It must not be used for office or school work, or other activities which can be performed in 
   another room, and different setting such as table and a chair. 
