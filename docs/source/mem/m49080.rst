...
**Atkinson and Shriffen's Model**, described in 1968, also describes such three systems 
...
.. tip:: 
   ...
   Material is well-encoded when it is more meaningful. For instance, think about 
   the prevalence of schizophrenia, 0.7% in the general population. Now, we can
   make it more meaningful by rounding it off to 1 percent or one out of every hundred. 
   If you know the prevalence of OCD is about 2%, you can make it more meaningful: OCD is twice
   as common as schizophrenia, in other words, schizophrenia is almost as prevalent.  
   ...
   in men, OCD may not be more prevalent than schizophrenia. 
...
whilst semantic encoding is the deepest. The approach 
...
.. hint:: 
   ...
   How could semantic encoding help as you attempt to 
   memorize the concepts in this chapter?
...
for a brief duration of up to a couple of seconds, without processing it. 
...
someone is particularly attentive to people's dressing, chances are
...
we selectively attend to a certain information, it will move into our
...
.. admonition:: Stroop Effect
   ...
   **Stroop Colour Word Test**, a popular neuropsychological tool
   ...
   words you are given in :numref:`(fig %s) <cnx_psych_08_01_stroop>`__. Do not read
...
and **echoic** memory, which corresponds to audition are the two most studied subtypes of sensory memory. 
...
**working memory** or **attention-span**. Short-term memory takes information from sensory memory
...
.. admonition:: Attention, short-term and working memory, disambiguation
   :class: attention

   The concept of "short-term memory" in Atkinson and Shriffin's model roughly equates our
   attention span or working memory. It is the capacity of an individual to hold information actively in the mind for mental manipulation. However, when we use the term working memory, as in 
   Baddeley's model, we also include its central executive system. Thus, working memory is our capacity to hold information actively in mind and our ability to mentally manipulate this information. 
   Short-term memory testing, as performed during mental state examination, however, is a test of new learning (see below).  
...
.. tip:: 
   ...
   Rehearsal of information in the mind helps transform short-term memories
   into longterm. However, unlike as described in the Atkinson's model, it is note the only
   mechanism. 
...
the visuospatial skeptechpad holds spatial and visual information. These two 
systems are shown to be controlled by different areas of the brain; more specifically
...
.. admonition:: Real-world Application: Making Most of Working Memory Capacity 
   ...
   Due to its lited capacity, when new information enters the
   working memory store, it replaces the existing chunks of information.  Thus, working memory 
   function is impaired by unhelpful stimuli from the environment, 
   intrusive thoughts. 
   To help enhance processing of information by the working memory, 
   a task that requires comprehension or memorisation should be performed in an environment 
...
.. admonition:: Clinical-correlate: Digit Span Test
  :class: hint
   ...
   manipulate information in the mind, the ability to sustain attention over 
...
:term:`Long-term memory (LTM)` is the continuous
...
.. admonition:: Clinical-correlate: Testing long-term memory. 
   ...
   asked to recall the three names. The number of items they can successfully recall (eg 2/3) is noted
   to be the value of short-term memory (not to be confused with the short-term memory concept
   used in Atkinson and Shriffin Model of Memory. 
...
.. figure:: ../resources/CNX_Psych_08_01_Explicit.jpg
   :scale: 100 %
   :align: center
...
when past experience with certain stimuli increases the speed or accuracy of identifying and naming
those stimuli. Sublimal advertising 

.. caution::
   
   Sublimal messages are used in manipulative tactics to 
...
In patients with dementia and other causes or neurogenic amnesia, retrospective
episodic memories 
are often lost in a temporal gradient; recent memories are more
severely affected than remote memories.  Clinically, these are tested 


.. card:: psychology everyday-connection

   .. card:: Can You Remember Everything You Ever Did or Said?
      ...
      superior autobiographical memory (`[link] <#id20>`__).
