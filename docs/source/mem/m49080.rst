...
.. tip:: 
   ...
   Material is well-encoded when it is more meaningful. 
...
and **echoic** memory, which corresponds to audition are the two most sutdied subtypes of sensory memory. 
