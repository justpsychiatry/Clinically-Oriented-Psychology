...
.. tip:: 
   ...
   Material is well-encoded when it is meaningful. 
...
and **echoic** memory, which coresponds to audition are the two most sutdied subtypes of sensory memory. 

But A-S is just one model of memory. Others, such as :footcite:p:`baddeleyWorkingMemory1974` 
Baddeley and Hitch
...
It involves recollection of visual
