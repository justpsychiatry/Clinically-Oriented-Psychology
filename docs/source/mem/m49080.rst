...
the visuospatial information is controlledd by the right hemisphere, the 
acoustic information by the left hemisphere. The episodic buffer helps with the 
integration of visual and auditory information in the working memory; retrival 
and storing information between the working memory and longterm memory stores. 
...
.. admonition:: Clinical-correlate: Digit Span Test
  :class: hint
   ...
   allowed to continue for five times. The number of correct answers are noted and scored. 
...
.. tip::
   Long-term memory store has no limits. 
...
you are learning will be part of your explicit memory. 
...
part of our consciousness. They are memories formed from behaviours.
