...
Memory refers to the formation, retention, and retrieval of learned associations, stored information, and skills. Several models of memory have been proposed. 
...
See :numref:`Title (Figure %s) <cnx_psych_08_01_memory>` for elaboration. 
...
See :numref:`Title <enriching_encoding>` 
...
1986) :footcite:p:`paivioMentalRepresentationsDual`, thus building a stronger memory.
...
.. admonition:: Stroop Effect
   ...
   **Stroop Colour Word Test**, a popular neuropsychological tool
   ...
   Try an experiment: name the colors of the
   ...
   .. figure:: ../resources/CNX_Psych_08_01_Stroop.jpg
      :scale: 100 %
      :align: center
      :alt: Stroop test
