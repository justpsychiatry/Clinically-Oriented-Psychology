...
.. card:: Classic Experiment
    ...
    .. figure:: ../resources/CNX_Psych_08_01_moris.png
      :scale: 70 %
      ...
      | **Results**                |                     |                  |
      +============================+=====================+==================+
      | **Encoding:**              | **Recognition       | **Rhyming        |
      |                            | test:**             | test:**          |
      +----------------------------+---------------------+------------------+
      | Does \___\_ rhyme with     | 63%                 | 49%              |
      | legal? (eagle)             |                     |                  |
      +----------------------------+---------------------+------------------+
      | Does \___\_ have feathers? | 84%                 | 33%              |
      | (eagle)                    |                     |                  |
      +----------------------------+---------------------+------------------+
