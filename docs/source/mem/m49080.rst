...
.. hint:: Stroop test
   ...
   .. figure:: ../resources/CNX_Psych_08_01_Stroop
      :scale: 100 %
      :align: center
      :alt: Stroop test
...
disastrous consequences for other types. :term:`Explicit memories` are those we consciously try to remember and recall.
