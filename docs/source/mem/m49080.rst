...
Memory refers to the formation, retention, and retrieval of learned associations, stored information 
, and skills. Several models of memory have been proposed. 

Process of Memory
*****************

The process of memory  is often compared
it to a computer. :term:`Memory` is the set of
processes used to encode, store, and retrieve information over different
periods of time (`[link] <#id14>`__).

.. figure:: ../resources/CNX_Psych_08_01_Memory.jpg
   :scale: 100 %
   :align: center
...
look away and count backwards from 30 by threes
